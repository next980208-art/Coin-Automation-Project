...
실행 시각은 2026-08-30 13:57 KST입니다. 최종 자동 검증 결과는 `healthy=true`였습니다.
...
```text
c6c7f8b0a690401f075dbbb1247829e4
```
...
```text
dd2c75184b4421764197da2cb903f3e9
```

입력 고유 건수는 10배가 되었지만 전체 시간은 약 1.17배가 됐습니다. 이번 크기에서는 Flink Job
...
정상 JSONL을 다시 사용해 1,000행을 처리했고 출력 1,000행, 중복 0건을 확인했습니다.
